...
public class TestSystem {
    ...
    public void test(LIS lis, int exp2, int exp3, int[][] exp4) {
        ...
        String ans = " [lengthLIS: actual=" + act2 + ", expected=" + exp2 + "][numOfLIS: actual=" + act3 + ", expected="
                + exp3 + "][allLIS: check:" + check4 + "]" + check;
    ...
    public void finalGrade() {
        ...
        System.out.println("Number of Errors: " + _errors + " of " + _tests + " tests, " + _errors
                + " errors , total time " + final_time + " ms.");
